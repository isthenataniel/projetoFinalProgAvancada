 ...
 * @author nataniel
 */
public class estadoLista extends javax.swing.JFrame {
    ...
    public void carregarLista() {
        ...
        try {
            model = (DefaultTableModel) estadoLista.getModel();
            for (Estado estado : estadoControle.obtemTodosEstados()) {
                Object[] row  = {estado.getId(), estado.getNome(), estado.getUf(), estado.getPaisNome()};
                model.addRow(row);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private boolean validaRegistroSelecionado() {
        if (estadoLista.getSelectedRow() == -1) {
    ...
    private Integer obtemIdentificadorRegistroSelecionado() {
        Integer id = null;
        Object row = model.getDataVector().elementAt(estadoLista.getSelectedRow());
        id = (Integer) model.getValueAt(estadoLista.getSelectedRow(), 0);
        return id;
    }
    /**
    ...
    private void initComponents() {
        ...
        estadoLista = new javax.swing.JTable();
        ...
        jLabel1.setText("Lista de Estado");
        ...
        estadoLista.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código", "Estado", "UF", "País"
            }
        ) {
        ...
        jScrollPane1.setViewportView(estadoLista);
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        ...
        setVisible(false);
        new estado(obtemIdentificadorRegistroSelecionado()).setVisible(true);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        try {
            List<Estado> emUso = estadoControle.obtemEstadoEmUso(obtemIdentificadorRegistroSelecionado());
        ...
        if (opcao != null && opcao.equals(JOptionPane.OK_OPTION)) {
            estadoControle.excluir(obtemIdentificadorRegistroSelecionado());
            model.removeRow(estadoLista.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(estadoLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable estadoLista;
