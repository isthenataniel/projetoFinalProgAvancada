 ...
 * @author nataniel
 */
public class cidadeLista extends javax.swing.JFrame {
    ...
    public void carregarLista() {
        ...
        try {
            model = (DefaultTableModel) cidadeLista.getModel();
            for (Cidade cidade : cidadeControle.obtemTodasCidades()) {
                Object[] row  = {cidade.getId(), cidade.getNome(), cidade.getIbgeid(), cidade.getEstadoNome()};
                model.addRow(row);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private boolean validaRegistroSelecionado() {
        if (cidadeLista.getSelectedRow() == -1) {
    ...
    private Integer obtemIdentificadorRegistroSelecionado() {
        Integer id = null;
        Object row = model.getDataVector().elementAt(cidadeLista.getSelectedRow());
        id = (Integer) model.getValueAt(cidadeLista.getSelectedRow(), 0);
        return id;
    }
    ...
    private void initComponents() {
        ...
        cidadeLista = new javax.swing.JTable();
        ...
        cidadeLista.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Código", "Cidade", "IBGE", "Estado"
            }
        ) {
        ...
        jScrollPane1.setViewportView(cidadeLista);
    ...
    private void editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarActionPerformed
        ...
        setVisible(false);
        new cidade(obtemIdentificadorRegistroSelecionado()).setVisible(true);
    ...
    private void excluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_excluirActionPerformed
        ...
        try {
            List<Cidade> emUso = cidadeControle.obtemCidadeEmUso(obtemIdentificadorRegistroSelecionado());
        ...
        if (opcao != null && opcao.equals(JOptionPane.OK_OPTION)) {
            cidadeControle.excluir(obtemIdentificadorRegistroSelecionado());
            model.removeRow(cidadeLista.getSelectedRow());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cidadeLista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable cidadeLista;
